                            ...
                            <div class="content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" id="jumlah_produksi" placeholder="masukkan jumlah" class="form-control" required>
                                        <input type="hidden" id="produksi_id" value="{{ $id }}">
        ...
        $(document).ready(function () {
            ...
            $('#submit').click(function () {
                ...
                $.ajax({
                    ...
                    document.getElementById('jumlah_produksi').value = '';
